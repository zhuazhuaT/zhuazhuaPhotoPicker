...
-(void)initFuntionView{
    ...
    [_borderToolsView setSelectBlock:^(UIImage *image,UIEdgeInsets insets){
        // 左端盖宽度
//        CGFloat top = 56/2; // 顶端盖高度
//        CGFloat bottom = 210/2; // 底端盖高度
//        CGFloat left = 89/2; // 左端盖宽度
//        CGFloat right = 340/2; // 右端盖宽度
